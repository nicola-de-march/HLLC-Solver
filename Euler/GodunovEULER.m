        ...
        case 0
            ...
            if (i==1)
                ...
                [QGod(1), QGod(2), QGod(3)] = ExactRiemannEuler(VL(1), VR(1), ...
                                         ...
                                         s, gamma, gamma);
                fp = f(QGod);
                [QGod(1), QGod(2), QGod(3)] = ExactRiemannEuler(2*V_init_L(1) - VL(1), VR(1), ...
                                         2*V_init_L(2) - VL(2), VR(2), ...
                                         2*V_init_L(3) - VL(3), VR(3), ...
                                         s, gamma, gamma);
                fm = f(QGod);
            elseif (i==IMAX)
                ...
                [QGod(1), QGod(2), QGod(3)] = ExactRiemannEuler(VL(1), 2*V_init_R(1) - VR(1), ...
                                         VL(2), 2*V_init_R(2) - VR(2), ...
                                         VL(3), 2*V_init_R(3) - VR(3), ...
                                         s, gamma, gamma);
                fp = f(QGod);
                [QGod(1), QGod(2), QGod(3)] = ExactRiemannEuler(VL(1), VR(1), ...
                                         VL(2), VR(2), ...
